...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 26, 2024 at 06:54 AM
...
INSERT INTO `produk` (`id_produk`, `material`, `nama_produk`, `ukuran`, `finishing`, `harga_modal`, `harga_jual`, `jumlah_stok`) VALUES
(1, 'teraso', 'silinder', '30x30', 'PBS', '100000', '300000', 10),
(2, 'teraso', 'silinder', '40x40', 'PBS', '200000', '450000', 10),
(3, 'teraso', 'silinder', '50x50', 'PBS', '300000', '600000', 10);
...
ALTER TABLE `sistem_kasir`
  ...
  ADD UNIQUE KEY `id_kasir` (`id_kasir`,`id_produk`,`id_sumber`,`id_kota`),
  ADD UNIQUE KEY `id_status` (`id_status`),
  ADD UNIQUE KEY `id_payment` (`id_payment`),
  ADD UNIQUE KEY `id_finishing` (`id_finishing`),
